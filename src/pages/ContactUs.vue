        ...
        <div class="row no-gutters">
            <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-5 order-lg-2">
                ...
                <ul class="contact-info__list list-style--none position-relative z-index-101">
                    ...
                    <li class="mb-4 pl-4">
                        <!-- <span class="position-absolute"><i class="call-outline"></i></span> +256200938600  +256759908600  +256752550207 -->
                        <span class="position-absolute"></span> +256200938600  +256759908600  +256752550207
                    </li>
                    <li class="mb-4 pl-4">
                        <span class="position-absolute"><i class="fas fa-map-marker-alt"></i></span> Petrografix Mineral
                        <br> Kawafu, Entebbe
                        <br> P.O.Box 700746 Entebbe
            ...
            <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1">
                <form action="#" class="contact-form form-validate" >
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <button type="submit" name="submit" class="btn btn-secondary btn-lg" disabled>Submit</button>
                        </div>
